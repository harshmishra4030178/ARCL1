...
const ProductCatalogPdfPage = ({ initialSlug, initialProduct = null }) => {
  ...
  const handleDirectDownload = async () => {
    ...
    try {
      ...
      // 1. Pre-convert all images in document to base64 Data URLs so canvas is never tainted
      ...
      // 2. Render DOM to High-Resolution Canvas using html-to-image or html2canvas-pro
      let canvas = null;
      try {
      ...
      // 3. Multi-page slice PDF construction
      ...
      // Report runtime error to Error Monitoring Dashboard
      reportClientError({
      ...
      // Execute fallback PDF download so the user always receives the file
      try {
