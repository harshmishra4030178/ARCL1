...
const drawOfficialHeader = (doc, title = "Official Document", accentColor = "#b91c1c") => {
  ...
  doc
    ...
    .fillColor("#475569")
    .text(
      "Gala No. 4, Shree Sai Shradha Industrial Park, Kaman, Vasai East, Palghar - 401208 | Phone: +91 8009559900 | Email: arclinstruments@gmail.com",
      115,
      50,
      { width: 445 }
    );
...
export const generateTaxInvoicePdf = async (customData = {}) => {
  ...
  const drawFullTaxHeader = (doc) => {
    ...
    doc.text("GSTIN: 27AATCA7874C1ZB | Phone: +91 8009559900 | Email: arclinstruments@gmail.com", 110, topY + 32);
